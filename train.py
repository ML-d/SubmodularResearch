...
def train_model(model, x_train, y_train, x_test, y_test,
    ...
    for exp_num in range (0, num_exp):
        ...
        np.save (folder + "train_acc_model_" + str (exp_num) + "_k" + str(approx_factor) + "_kernel" + str(kernel), train_acc)
        np.save (folder + "val_acc_model_" + str (exp_num) + "_k" + str(approx_factor)+ "_kernel" + str(kernel), val_acc)
        np.save (folder + "train_loss_model_" + str (exp_num) + "_k" + str(approx_factor)+ "_kernel" + str(kernel), train_loss)
        np.save (folder + "val_loss_model_" + str (exp_num) + "_k" + str(approx_factor)+ "_kernel" + str(kernel), val_loss)
