...
def train_model(model, x_train, y_train, x_test, y_test,
    ...
    for exp_num in range (0, num_exp):
        ...
        np.save (folder + "train_acc_model_" + str (exp_num) + "_" + str(approx_factor), train_acc)
        np.save (folder + "val_acc_model_" + str (exp_num) + "_" + str(approx_factor), val_acc)
        np.save (folder + "train_loss_model_" + str (exp_num) + "_" + str(approx_factor), train_loss)
        np.save (folder + "val_loss_model_" + str (exp_num) + "_" + str(approx_factor), val_loss)
